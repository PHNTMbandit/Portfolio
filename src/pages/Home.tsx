...
const Home = () => {
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex gap-4 mt-6 opacity-0 place-self-center animate-slidein [--slidein-delay:400ms]">
        <SocialMediaLink
      ...
      <div className="flex flex-col mt-6 justify-start items-start space-y-3">
      ...
      <div className="flex flex-wrap mt-10 gap-5 opacity-0 animate-slidein [--slidein-delay:1200ms]">
        <Html5 size={23} />
        <Css3 size={23} />
        <Python size={23} />
        <Javascript size={23} />
      ...
      <div className="flex flex-wrap mt-10 gap-4 opacity-0 animate-slidein [--slidein-delay:1400ms]">
        <ProjectCard
